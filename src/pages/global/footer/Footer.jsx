        ...
        <div className="flex flex-wrap flex-row lg:justify-between -mx-3">
          <div className="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
            <div className="flex items-center mb-2">
              <span className="text-3xl leading-normal mb-2 font-bold text-gray-800 mt-2"><span className="text-red-600">Voter</span>.com</span>
            </div>
            <p>The Best App Ever To Vote.</p>
            <ul className="space-x-3 mt-6 mb-6 Lg:mb-0">
         
              <li className="inline-block">
                <a target="_blank" className="hover:text-gray-800" rel="noopener noreferrer" href="https://facebook.com" title="Facebook">
              ...
              <li className="inline-block">
                <a target="_blank" className="hover:text-gray-800" rel="noopener noreferrer" href="https://twitter.com" title="Twitter">
              ...
              <li className="inline-block">
                <a target="_blank" className="hover:text-gray-800" rel="noopener noreferrer" href="https://youtube.com" title="Youtube">
              ...
              <li className="inline-block">
                <a target="_blank" className="hover:text-gray-800" rel="noopener noreferrer" href="https://instagram.com" title="Instagram">
          ...
          <div className="flex-shrink max-w-full w-full lg:w-3/5 px-3">
            <div className="flex flex-wrap flex-row">
              <div className="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
                <h4 className="text-base leading-normal mb-3 uppercase text-gray-800">Support</h4>
                <ul>
                  <li className="py-1 hover:text-gray-900"><a href="docs/index.html">Documentation</a></li>
      ...
      <div className="container xl:max-w-6xl mx-auto px-4 py-4 border-t border-gray-200 border-opacity-10">
        <div className="row">
          <div className="col-12 col-md text-center">
            <p className="d-block my-3">Copyright © MKM IT SOLUTION | All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
